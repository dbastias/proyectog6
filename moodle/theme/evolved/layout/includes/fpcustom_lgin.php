...
<?php require_once(dirname(__FILE__).'/alerts.php'); ?>
    ...
    if ($PAGE->theme->settings->fpslideshow==1 && isloggedin()) { ?>
        <div class="slider">
            ...
            <label for="id1">
                <img src="<?php echo $PAGE->theme->setting_file_url('back1', 'back1', true); ?>" />
            </label>
            <img src="<?php echo $PAGE->theme->setting_file_url('back1', 'back1', true); ?>"/>
            ...
            <label for="id2">
                <img src="<?php echo $PAGE->theme->setting_file_url('back2', 'back2', true); ?>" />
            </label>
            <img class="slidemain" src="<?php echo $PAGE->theme->setting_file_url('back2', 'back2', true); ?>"/>
            
            <input type="radio" name="slide_switch" id="id3"/>
            <label for="id3">
                <img src="<?php echo $PAGE->theme->setting_file_url('back3', 'back3', true); ?>" />
            </label>
            <img class="slidemain" src="<?php echo $PAGE->theme->setting_file_url('back3', 'back3', true); ?>"/>
            
            <input type="radio" name="slide_switch" id="id4"/>
            <label for="id4">
                <img src="<?php echo $PAGE->theme->setting_file_url('back4', 'back4', true); ?>" />
            </label>
            <img class="slidemain" src="<?php echo $PAGE->theme->setting_file_url('back4', 'back4', true); ?>"/>
        </div>
<div style="clear:both;"></div>
    <?php } else { ?>
    <br>
